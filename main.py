...
UPDATE_CHNL = os.environ.get("UPDATE_CHNL","KAIRAUPDATES")
OWNER_USERNAME = os.environ.get("OWNER_USERNAME","FEELINGLESSXD")
SUPPORT_GRP = os.environ.get("SUPPORT_GRP","THEXSWAGGERS")
BOT_NAME = os.environ.get("BOT_NAME","CHATBOT")
START_IMG = os.environ.get("START_IMG","https://graph.org/file/4fab7068a9af8a8596327.jpg")
