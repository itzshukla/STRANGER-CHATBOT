...
UPDATE_CHNL = os.environ.get("UPDATE_CHNL","mastiwithfriendsx")
OWNER_USERNAME = os.environ.get("OWNER_USERNAME","shiva_ansh_op")
...
SOURCE = 'https://telegra.ph/file/038602f34ce054644b9a9.jpg'
x=["❤️","🎉","✨","🪸","🎉","🎈","🎯"]
g=choice(x)
