...
BOT_USERNAME = os.environ.get("BOT_USERNAME","Harsh_chat_bot") 
UPDATE_CHNL = os.environ.get("UPDATE_CHNL","harshit_g91")
OWNER_USERNAME = os.environ.get("OWNER_USERNAME","harsh4442")
SUPPORT_GRP = os.environ.get("SUPPORT_GRP","harshit_g91")
