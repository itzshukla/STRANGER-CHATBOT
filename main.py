...
UPDATE_CHNL = os.environ.get("UPDATE_CHNL","The_incricible")
OWNER_USERNAME = os.environ.get("OWNER_USERNAME","your_godfather_xd")
SUPPORT_GRP = os.environ.get("SUPPORT_GRP","incricible")
...
SOURCE = 'https://t.me/The_Incricible/24'
x=["❤️","🎉","✨","🪸","🎉","🎈","🎯"]
g=choice(x)
